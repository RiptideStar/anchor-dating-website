...
<div
  ...
  style={{
    // Position to match iPhone screen area
    top: "8%",
    left: "6%",
    right: "6%",
    bottom: "8%",
    opacity: phoneContentOpacity,
    transform: `scale(${phoneContentScale})`,
  }}
>
  {/* Status Bar */}
  <div className="bg-white px-4 py-2 flex items-center justify-between border-b border-gray-100">
  ...
  {/* Phone Content */}
  <div
    className="p-6 space-y-6 bg-white overflow-y-auto"
  ...
  >
    ...
    <div className="w-full h-48 bg-gradient-to-br from-amber-50 to-rose-50 rounded-xl flex items-center justify-center border border-gray-100">
      <div className="text-center">
        <div className="text-4xl mb-2">🍽️</div>
        <p className="text-xs text-gray-400 font-serif">Dinner Table</p>
      </div>
    </div>
    ...
    <div className="grid grid-cols-2 gap-4">
      <div>
        <p className="text-xs text-gray-500 font-serif mb-1">WHERE?</p>
        <p className="text-sm font-serif text-black">Cipriana</p>
      </div>
      <div>
        <p className="text-xs text-gray-500 font-serif mb-1">WHEN?</p>
        <div className="flex items-center gap-2">
          <span className="text-xs">📅</span>
          <div>
            <p className="text-sm font-serif text-black">Tue, Dec 30.</p>
            <p className="text-xs font-serif text-gray-600">3:05 PM</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div>
    ...
    {/* Profile Card */}
    <div
      className="relative rounded-xl p-4 flex gap-4 items-start overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="relative z-10 flex gap-4 w-full">
        ...
        <div className="flex-1">
          <div className="flex justify-between items-start mb-3">
            <h3 className="text-xl font-serif font-bold text-white">Antony</h3>
            <span className="text-xs text-gray-400 font-serif">
              Anchor Card
            </span>
          </div>
          <div className="space-y-1.5">
            <div className="flex items-center gap-2">
              <span className="text-xs text-gray-400 font-serif">AGE</span>
              <span className="text-sm text-white font-serif">20</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-xs text-gray-400 font-serif">HGT</span>
              <span className="text-sm text-white font-serif">5'10</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-xs text-gray-400 font-serif">OCC</span>
              <span className="text-sm text-white font-serif">Founder</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-xs text-gray-400 font-serif">LOC</span>
              <span className="text-sm text-white font-serif">
                Nueva York, NY
              </span>
            </div>
